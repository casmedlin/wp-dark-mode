...
function appendThemeSwitch() {
    ...
    let html = `<div id="wpDarkModeThemeSwitch"><img id="wpDarkModeThemeSwitchImg" src="${wpDarkMode.pluginUrl}/block/build/images/default.png" /> <i class="wpdm-arrow down"></i> </div>`;
