<div class="license-activation-notice">
    ...
    <div class="wp-dark-mode-notice-actions">
        <a href="<?php echo admin_url( 'admin.php?page=wp-dark-mode-settings#wp_dark_mode_license' ); ?>" class="button button-primary activate-license"><?php _e( 'Activate License',
				'wp-dark-mode' ); ?></a>
